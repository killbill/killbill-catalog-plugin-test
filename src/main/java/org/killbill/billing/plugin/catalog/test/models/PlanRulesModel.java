...
public class PlanRulesModel implements PlanRules {
    ...
    public PlanRulesModel(final Iterable<Product> products, Iterable<Plan> plans, Iterable<PriceList> priceLists) {
    ...
    public void addCaseBillingAlignmentRule(final Product product,
        ...
        caseBillingAlignments.add(new CaseBillingAlignmentModel(product, productCategory, billingPeriod, priceList, phaseType, billingAlignment));
    }
    ...
    public void addCaseCancelRule(final Product product,
        ...
        caseCancelPolicy.add(new CaseCancelPolicyModel(product, productCategory, billingPeriod, priceList, phaseType, billingActionPolicy));
    ...
    public void addCaseChangeAlignmentRule(final PhaseType phaseType,
        ...
        caseChangePlanAlignment.add(new CaseChangePlanAlignmentModel(phaseType, findProduct(fromProduct), fromProductCategory, fromBillingPeriod, findPriceList(fromPriceList), findProduct(toProduct), toProductCategory, toBillingPeriod, findPriceList(toPriceList), planAlignmentChange));
    }
    ...
    public void addCaseChangePlanPolicyRule(final PhaseType phaseType,
        ...
        caseChangePlanPolicy.add(new CaseChangePlanPolicyModel(phaseType, findProduct(fromProduct), fromProductCategory, fromBillingPeriod, findPriceList(fromPriceList), findProduct(toProduct), toProductCategory, toBillingPeriod, findPriceList(toPriceList), policy));
    }
    ...
    public void addCaseCreateAlignmentRule(final Product product,
        ...
        caseCreateAlignment.add(new CaseCreateAlignmentModel(product, productCategory, billingPeriod, priceList, planAlignmentCreate));
    }
    ...
    public void addPriceListRule(final Product product,
        ...
        casePriceList.add(new CasePriceListModel(product, productCategory, billingPeriod, priceList, destPriceList));
    }
