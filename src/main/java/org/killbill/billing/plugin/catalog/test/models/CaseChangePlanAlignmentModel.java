...
public class CaseChangePlanAlignmentModel extends CaseChangeModel implements CaseChangePlanAlignment {

    private final PlanAlignmentChange planAlignmentChange;

    public CaseChangePlanAlignmentModel(final PhaseType phaseType,
