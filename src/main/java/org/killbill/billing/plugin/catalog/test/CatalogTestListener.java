...
public class CatalogTestListener implements OSGIKillbillEventDispatcher.OSGIKillbillEventHandler {
    ...
    public void handleKillbillEvent(final ExtBusEvent killbillEvent) {
        ...
        try {
            final Account account = osgiKillbillAPI.getAccountUserApi().getAccountById(killbillEvent.getAccountId(), new CatalogTestContext(killbillEvent.getTenantId()));
    ...
    private static final class CatalogTestContext implements TenantContext {
        ...
        private CatalogTestContext(final UUID tenantId) {
