...
public class CatalogListener implements OSGIKillbillEventDispatcher.OSGIKillbillEventHandler {

    private final static Logger logger = LoggerFactory.getLogger(CatalogListener.class);
    private final OSGIKillbillAPI osgiKillbillAPI;

    public CatalogListener(final OSGIKillbillAPI killbillAPI) {
