...
public class CaseChangePlanPolicyModel extends CaseChangeModel implements CaseChangePlanPolicy {

    private final BillingActionPolicy billingPolicy;

    public CaseChangePlanPolicyModel(final PhaseType phaseType,
